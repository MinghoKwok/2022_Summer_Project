...
#include <iostream>
#include <string>
#include "Student/student.pb.h"
#include "Student/mapRes.pb.h"
#include <cstdio>
#include <sstream>
...
//    writer.WriteProtocolMessage(serializedStr);
...
//        string str;
//        IsRead >> str;
//        strToDecode.append(str);
//    }

//    string tempstr;
//    while (getline(IsRead, tempstr)) {
//        strToDecode = strToDecode + tempstr + "\n";
//    }
    IsRead.close();

    cout << "++++++++++++++++++++++" << endl << strToDecode << endl;
...
//    cout <<endl<<"Map Results: " << (deserializedMapRes.testmap())["666"] << endl;
    ...
    if (it != deserializedMapRes.testmap().end()) {
        ...
        if (it_0 != it->second.map_offset_src().end()) {
            cout << it_0->second.src_path() << " " << (int)(it_0->second.src_line()) << endl;
